...
<head>
	...
	<script type="text/javascript" src="https://ajax.googleapis.com/ajax/libs/jquery/<?php echo s($jQueryVersion); ?>/jquery.min.js"></script>
<?php if($config['anywhere_apikey']){ ?>	<script type="text/javascript" src="https://platform.twitter.com/anywhere.js?id=<?php echo s($config['anywhere_apikey']); ?>&amp;v=1"></script><?php echo "\n"; } ?>
...
<body>
	<div id="container">
		<div id="top">
			<div id="author">
				<h2><a href="https://twitter.com/<?php echo s($config['twitter_screenname']); ?>"><strong><?php echo s($author['realname']); ?></strong> (@<?php echo s($config['twitter_screenname']); ?>)<img src="<?php echo s($author['profileimage']); ?>" width="48" height="48" alt="" /></a></h2>
...
<?php if($config['follow_me_button']){ ?>				<p class="follow"><a href="https://twitter.com/<?php echo s($config['twitter_screenname']); ?>">Follow me on Twitter</a></p><?php echo "\n"; } ?>
			</div>
		</div>
		<div id="content">
